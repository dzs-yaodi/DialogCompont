...
public class DeviceHelper {
    ...
    private static Pattern FLYME_PATTERN = Pattern.compile("(\\d+\\.){2}\\d");
    ...
    private static boolean sIsTablet(Context context) {
    ...
    public static boolean isFlymeVersionHigher5_2_4() {
        ...
        if (sFlymeVersionName != null && !"".equals(sFlymeVersionName)) {
            Matcher matcher = FLYME_PATTERN.matcher(sFlymeVersionName);
            if (matcher.find()) {
